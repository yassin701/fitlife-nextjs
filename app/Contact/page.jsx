  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center py-20">
      <form
        ...
        className="grid gap-6 bg-gray-800 p-10 rounded-2xl shadow-lg w-full max-w-lg"
      >
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className={`px-4 py-2 rounded-lg bg-gray-700 border ${
        ...
        {/* Message */}
        <div className="flex flex-col">
          <label className="text-gray-200 mb-1">Fitness Goals</label>
          <textarea
            name="message"
            ...
            rows={4}
            className={`px-4 py-2 rounded-lg bg-gray-700 border ${
              errors.message ? "border-red-500" : "border-gray-500/30"
            } text-white focus:border-blue-400 focus:ring-1 focus:ring-blue-400 outline-none transition`}
        ...
        <button
          type="submit"
          className="bg-gradient-to-r from-blue-400 to-purple-500 text-white font-bold py-3 rounded-xl text-lg hover:shadow-2xl hover:shadow-blue-400/40 transition-all duration-300 transform hover:-translate-y-1"
        >
          Send
        </button>
      </form>
